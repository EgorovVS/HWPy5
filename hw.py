...
# def extra_text(text):          # функция проверяет текст на наличие 'абв'
#     if not 'абв' in text:
#         return True 
...
# clear_text = filter(extra_text,text_list) # filter используя функцию extra_text 
#                                             # фильтрует список
# print(list(clear_text)) # list используется для вывода т.к тип данных filter
# text
